...
import com.example.dbmigration.theapp.domain.Address;
    ...
    class Update {
        ...
        void shouldDelegateToService() throws Exception {
            ...
            mockMvc.perform(patch("/api/customer-profiles/profile-id")
                    ...
                    .andExpect(content().json("""
                            {"id": "profile-id","firstName": "Joe","lastName": "Doe","email": "joe.doe@test.org"}
                            """));
    ...
    class Get {
        ...
        void shouldDelegateToService() throws Exception {
            ...
            mockMvc.perform(get("/api/customer-profiles/" + id)
                    ...
                    .andExpect(status().isOk())
                    .andExpect(content().json("""
                            {"id": "customer-profile-id","firstName": "Joe","lastName": "Doe","email": "joe.doe@test.org"}
                            """));
